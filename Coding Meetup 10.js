...
@return {array of object key:value}
@solution with {map}{Date.prototype.getFullYear} select one array element at a time, create a new key in it ,than with {template string} create username value based on the data in the object, 
*/
